  ...
  Future<Transaction> _send(Transaction transactionCreated, String password,
    ...
    await _webClient.save(transactionCreated, password).catchError((e) {
      ...
      if (FirebaseCrashlytics.instance.isCrashlyticsCollectionEnabled) {
        FirebaseCrashlytics.instance.setCustomKey('exeption', e.toString()); //Pega a excecao e o objeto da excecao, assim fica mais facil identificar o erro e nomeia com uma chave (exeption)
        FirebaseCrashlytics.instance.setCustomKey('http_body', transactionCreated.toString()); //Pega o objeto (instancia da classe Transacao) e nomeia com uma chave (http_body)
